...
const CustomCheckbox = ({ id, isChecked, setIsChecked }: CheckboxInterface) => {
  return (
    <StyledWrapper>
      <div className="container">
        {/* Corrected: Linked id properly */}
        <input
          type="checkbox"
          id={id}
          style={{ display: 'none' }}
...
const StyledWrapper = styled.div`
  ...
  .check:hover svg {
    stroke: var(--accent-color, #d6d50c);
  }

  /* ✅ Fixed selector to target checked input */
